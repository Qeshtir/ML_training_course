...
with DAG(
    ...
    dag.doc_md = __doc__  # Можно забрать докстрингу из начала файла вот так (пример в строках 1-3 текущего файла)
    dag.doc_md = """
    ...
    def print_context(ds, **kwargs):  # аргументы kwargs - словарь
